...
Another repository consumes it as the `commit-attribution` hook published by `.pre-commit-hooks.yaml`,
pinned by `rev`, instead of copying this file (decision 2026-09-23-005).
...
def main(argv: list[str] | None = None) -> int:
    """`argv` is the full argument vector; None reads the process's own, as the console script
    published by pyproject.toml does (decision 2026-09-23-005)."""
